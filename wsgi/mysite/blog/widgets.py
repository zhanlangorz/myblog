...
class TreeSelect(Select):
    ...
    def render_option(self, selected_choices, option_value, option_label):
        ...
        conditional_escape(force_text(option_label)).replace(' ', ' '))
    ...
    def render_options(self, choices, selected_choices):
        ...
        for option_value, option_label in chain(self.choices, choices):
            if isinstance(option_label, (list, tuple)):
                output.append(u'<optgroup label="%s">' % escape(force_text(option_value)).replace(' ', ' '))
...
class MySelect(Select):
     ...
     def render_options(self, choices, selected_choices):
         ...
         for option_value, option_label in chain(self.choices, choices):
              # if option_value in selected_choices:
              #     ret.append(u'<option selected="selected" >'+force_text(option_label)+'</option>' )
              # else:
              #     ret.append(u'<option>'+force_text(option_label)+'</option>' )
